...
const file = document.querySelector('#file-menu');
...
// file menu display and styles
file.addEventListener('click', () => {
    document.querySelector('.home').style.visibility = 'hidden';
    document.querySelector('#file-menu>a').style.color = 'rgb(8, 151, 8)';
    document.querySelector('#home-menu>a').style.color = 'white';
    document.querySelector('.file').style.display = 'flex';
    home.classList.remove('active-menu');
    file.classList.add('active-menu');
})

// home menu display and styles
home.addEventListener('click', () => {
    document.querySelector('.home').style.visibility = 'visible';
    document.querySelector('#file-menu>a').style.color = 'white';
    document.querySelector('#home-menu>a').style.color = 'rgb(8, 151, 8)';
